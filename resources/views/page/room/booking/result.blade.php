            ...
            <div class="card" style="width: 50rem;">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        ...
                        ผู้เข้าพักจำนวน : 2 ท่าน
                    </li>
                    <li class="list-group-item">
                        <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
                        </svg>ชื่อผู้เข้าพัก : จักรพรรดิ อินทรัตน์
                    </li>
                    <li class="list-group-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        </svg>หมายเลขบัตรประชาชนผู้เข้าพัก : 1909802582727
                    </li>
                    <li class="list-group-item">
                        <svg class="me-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        </svg>อีเมล์ผู้เข้าพัก : jakkapatintarat92@gmail.com
                    </li>
                    <li class="list-group-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        </svg>เบอร์โทรผู้เข้าพัก : 0841085079
                    </li>
                    <li class="list-group-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
